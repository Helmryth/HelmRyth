...
public enum ConnectionAdvice {
    ...
    public static func message(
        ...
        case .cannotConnectToHost:
            advice = "Reached your workbench, but Phone access isn't answering on port \(port) — open Helmryth → Settings → Reach."
        case .timedOut:
            advice = "No route to your workbench at \(host) — different network, or a firewall."
