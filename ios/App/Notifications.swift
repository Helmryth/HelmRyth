...
final class NotificationCoordinator: NSObject, UNUserNotificationCenterDelegate {
    ...
    func deliver(_ notification: NotificationFrame, sequence: Int?) {
        ...
        content.categoryIdentifier = notification.isBlocking ? "HELMRYTH_APPROVAL" : "HELMRYTH_UPDATE"
        ...
        let identifier = "helmryth.\(notification.threadId).\(sequence.map(String.init) ?? notification.title)"
