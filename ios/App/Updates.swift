...
//
// Three kinds, in the order a person cares about them — an operator that has
// stopped and needs an answer, an operator mid-turn, and an operator that
// finished with something you have not read. An operator that is idle and read
// is not an update and never appears here; that is what the roster below is for.
import Foundation
