...
//
// On-device when the recognizer supports it, so talking to an operator does not
...
final class SpeechDictation: ObservableObject {
    ...
    static let speechDeniedMessage =
        "Dictation needs Speech Recognition access. Enable it in Settings → Helmryth Mobile."
    static let micDeniedMessage =
        "Dictation needs Microphone access. Enable it in Settings → Helmryth Mobile."
}
