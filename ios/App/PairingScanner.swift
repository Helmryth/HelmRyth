...
// payload is returned to PairingView, which shows the workbench name and
            ...
            Group {
                if !permissionResolved {
                    ...
                    ContentUnavailableView {
                        ...
                        Text("Allow camera access to scan the pairing QR code shown by Helmryth.")
                    } actions: {
                    ...
                    ZStack(alignment: .bottom) {
                        ...
                        VStack(spacing: 8) {
                            Text(validationError ?? "Point the camera at the QR code on your workbench")
