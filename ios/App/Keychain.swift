...
enum Keychain {
    private static let service = "com.helmryth.companion.token"
    ...
    static func save(_ token: String, for connectionId: String) throws {
        ...
        // already gone, and the phone is signed out of a workbench it was
    ...
    /// means walking to the workbench for a new code.
    ///
