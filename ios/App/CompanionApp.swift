...
/// phone on the workbench — which is exactly what that button is for, so the
    ...
    var body: some View {
        NavigationStack {
            ContentUnavailableView {
                ...
                Text("The connection was removed on your workbench. Pair again to keep using your chats here.")
            } actions: {
