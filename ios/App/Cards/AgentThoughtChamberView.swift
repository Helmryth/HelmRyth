...
public struct AgentThoughtChamberView: View {
    ...
    public init(
        reasoning: String,
        botName: String = "Bot",
        sigilColor: Color = .purple,
        isStreaming: Bool = false
    ) {
        self.reasoning = reasoning
        self.botName = botName
        self.sigilColor = sigilColor
    ...
    public var body: some View {
        ...
        .overlay(
            RoundedRectangle(cornerRadius: 12, style: .continuous)
                .stroke(isDark ? sigilColor.opacity(0.3) : Color.black.opacity(0.08), lineWidth: 0.65)
        )
        ...
        Button {
            ...
            HStack(spacing: 6) {
                Image(systemName: "brain.head.profile")
                    ...
                    .foregroundColor(sigilColor)
                
                Text(isStreaming ? "Tracing…" : "Trace Ledger")
