...
final class EndpointRefreshTests: XCTestCase {
    ...
    func testFetchesTheAuthenticatedEndpointSnapshot() async throws {
        ...
        XCTAssertEqual(metadata.serverName, "Divyam's computer")
    ...
    private static let fullMetadata = Data(
        #"{"serverName":"Divyam's computer","hosts":["mac.tail1234.ts.net","192.168.1.42"],"endpoints":[{"url":"http://192.168.1.42:8810","kind":"lan","priority":200},{"url":"http://not-a-tailnet.example:8810","kind":"tailnet","priority":50},{"url":"http://mac.tail1234.ts.net:8810","kind":"tailnet","priority":100},{"url":"https://mac.companion.example","kind":"hosted","priority":0}]}"#.utf8
    )
}
