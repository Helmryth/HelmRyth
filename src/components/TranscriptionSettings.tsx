...
export function TranscriptionSettings() {
  const bridge = window.helmryth?.transcription;
  ...
  return (
    ...
    >
      ...
      <p className="mb-2 text-[12px] leading-relaxed text-ink-secondary">
        Live narration for recorded methods. Audio is sent to AssemblyAI only while recording; the API key is protected by your operating system.
      </p>
