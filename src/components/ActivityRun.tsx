      ...
      <div className="flex flex-col gap-1">
        <div className="flex justify-start">
          <button
            ...
            aria-expanded
            className="flex items-center gap-2 rounded-sm border border-hairline/60 bg-panel px-3 py-1.5 text-[13px] text-ink-secondary hover:bg-control"
          >
  ...
  return (
    <div className="flex justify-start">
      <button
        ...
        className={cn(
          "flex items-center gap-2 rounded-sm border border-hairline/60 bg-panel px-3 py-1.5 text-[13px] hover:bg-control",
