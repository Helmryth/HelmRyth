...
Helmryth stages the official `cloudflared` 2026.8.2 executable as a separate
...
| Helmryth target | Release asset | Release asset SHA-256 | Extracted executable SHA-256 |
| --- | --- | --- | --- |
...
The macOS release process applies Helmryth's Developer ID signature to the
