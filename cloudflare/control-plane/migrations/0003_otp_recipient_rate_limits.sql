...
-- Authenticated accounts are still untrusted. Bound node row churn
-- separately from Better Auth's public reach limits.
CREATE TABLE registry_action_rate_limits (
