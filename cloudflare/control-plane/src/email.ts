...
const SUBJECTS = {
  "sign-in": "Your Helmryth sign-in code",
  "email-verification": "Verify your Helmryth email",
  "forget-password": "Reset your Helmryth password",
  "change-email": "Confirm your Helmryth email change",
