...
// with ERR_MODULE_NOT_FOUND. The isolated packaged-server smoke proves this
// boundary before any release artifact is accepted.
//
...
// pi-mcp-extension.ts is NOT an Helmryth entry point: it is loaded by the
