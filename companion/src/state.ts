...
// ~/.helmryth would be reaching into somebody else's data layout — the
...
/** HELMRYTH_COMPANION_DIR isolates a test rig from a real paired fleet. */
export const DATA_DIR = process.env.HELMRYTH_COMPANION_DIR ?? join(homedir(), ".helmryth-companion");
