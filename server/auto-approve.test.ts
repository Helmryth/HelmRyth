...
describe("looksSensitive", () => {
  for (const text of [
    "cat .env",
    "cat /Users/operator/project/.env.production",
    "cat ~/.ssh/id_rsa",
...
describe("approvalKey", () => {
  ...
  it("leaves ordinary tools alone", () => {
    ...
    expect(approvalKey("mcp__helmryth__computer_batch", "click 5,5")).toBe("mcp__helmryth__computer_batch");
  });
