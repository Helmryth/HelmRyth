...
//
// A misplaced anchor resolves every proxy outside Resources/server. Permission
// prompting and external surfaces then fail while /api/health stays green.
//
 ...
 * the check that catches a misplaced bundle anchor. */
