...
export function isEffortLevel(value: JsonValue | undefined): value is EffortLevel {
...
export interface SendTurnInput {
  ...
  integrations?: {
    ...
    /** Cloud computer, reached through Helmryth's REST-to-MCP adapter.
...
/** JSON-compatible driver-owned configuration before the selected driver decodes it. */
export type ProviderConfigInput = JsonValue | undefined;
...
export interface ProviderDriver<Config = unknown> {
  ...
  decodeConfig(raw: ProviderConfigInput): Config;
